...
#define kXMInfoAlert_fontSize       14
#define kXMInfoAlert_width          200
#define kMax_ConstrainedSize        CGSizeMake(200, 100)

@implementation XMInfoAlert {
    CGColorRef bgcolor_;
    NSString *info_;
    CGSize fontSize_;
}
...
static XMInfoAlert *alertShare = nil;
...
#ifndef __IPHONE_7_0
    [info_ drawInRect:r withFont:[UIFont systemFontOfSize:kXMInfoAlert_fontSize] lineBreakMode:UILineBreakModeTailTruncation];
#else
    NSDictionary *attrsDictionary = [NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:kXMInfoAlert_fontSize], NSFontAttributeName,[NSNumber numberWithFloat:1.0],NSBaselineOffsetAttributeName,nil];
...
+ (void)showInfo:(NSString *)info 
    ...
    CGRect frame;
#ifndef __IPHONE_7_0
    CGSize size = [info sizeWithFont:[UIFont systemFontOfSize:kXMInfoAlert_fontSize]
                   constrainedToSize:kMax_ConstrainedSize];
    frame = CGRectMake(0, 0, size.width, size.height);
#else
    frame = [info boundingRectWithSize:kMax_ConstrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:kXMInfoAlert_fontSize]} context:nil];
    frame.origin = CGPointMake(0, 0);
#endif
    
    XMInfoAlert *alert = [[XMInfoAlert alloc] initWithFrame:frame bgColor:color info:info];
...
+ (void)showInfo_2:(NSString*)info
    ...
    alertShare = [[XMInfoAlert alloc] initWithFrame:frame bgColor:color info:info];
